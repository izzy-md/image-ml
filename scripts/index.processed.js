...
/***/ (function(module, exports) {
	...
	// import train from './tf-blurriness/train';
	// import isBlurry from './tf-blurriness';

	// Train the model
	// const dataset = new Dataset('url/to/some/json/file.json');
	// await train(await dataset.data);

	// Predict with the model
	// await isBlurry(url/to/SomeImage.png);
